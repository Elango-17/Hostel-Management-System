...
$query="insert into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,course,register_no,first_name,middle_name,last_name,gender,contact_num,email,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	<div class="ts-main-content">
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Student Hostel Registration </h2>
...
<div class="col-sm-8">
<input type="text" name="register_no" id="regno"  class="form-control" value="<?php echo $row->register_no;?>" readonly >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="middle_name" id="mname"  class="form-control" value="<?php echo $row->middle_name;?>"  readonly>
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="contact" id="contact" value="<?php echo $row->contact_num;?>"  class="form-control" readonly>
</div>
</div>
